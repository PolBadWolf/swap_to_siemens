...
protected:
	...
	const static uint16_t scrFlashMaxMsec = 1000;
// функции
protected:
// 	virtual ~Lcd();
...
public:
	...
	void PutChar(uint8_t  pos, char sim);
	void PutChar(char sim) { PutChar(&pos, sim); }
	...
	void Hex(uint8_t dig)									{ Hex(&pos, dig); }
	// --
